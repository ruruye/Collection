...
public class MapTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("별명 : " + map.get("alias")); // 값이 없기 때문
...
//		System.out.println("삭제된 value값 => " + removeTel);
		...
		System.out.println("alias 키값의 존재여부 : " + map.containsKey("alias"));
		
		System.out.println("--------------------------------------------");
		//--------------------------------------------------------------------------
		
		// Map에 저정된 모든 데이터를 읽어와서 사용하는 방법
		
		// 방법1 : Map의 모든 key값을 읽어와서 사용하는 방법 ==> keySet()메서드를 이용하기
		...
		// key값은 번호(int)로 하고 value값은 Member의 인스턴스로 하는 Map객체 생성하기 //ListSortTest02파일
